...
const SquawkCard = ({username, profilePic, postText, postImage, likes, user}) => {
    ...
    return (
        <div id="SquawkCard" className='border border-amber-500 rounded-lg p-3 bg-amber-100 overflow-hidden  mx-auto w-1/2 h-1/2 z-0'>
            <div className='top-3 left-3 pt-3 pl-3 flex flex-col'>
                ...
                <div className='p-3'>
                    ...
                    <button id="HookedButton" className=' bottom-2 right-3 bg-amber-200 w-24 h-auto rounded-lg flex flex-row p-2 gap-2 shadow-md' onClick={handleIncrement} >Hooked
