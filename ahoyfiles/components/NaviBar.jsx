...
const Navibar = ({ profilePic}) => {
  ...
  return (
<Navbar className ='sticky top-0 z-50 bg-base py-5'>
<NavbarBrand>
  <Dropdown className=" z-50" label={
